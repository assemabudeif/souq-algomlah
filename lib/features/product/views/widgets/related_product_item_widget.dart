...
class RelatedProductItemWidget extends StatefulWidget {
  const RelatedProductItemWidget({
    super.key,
  ...
  @override
  State<RelatedProductItemWidget> createState() =>
      _RelatedProductItemWidgetState();
}

class _RelatedProductItemWidgetState extends State<RelatedProductItemWidget> {
  _addToFavorite() {
    setState(() {
      ...
      if (sl<FavoriteService>().isFavorite(widget.product.id)) {
        ...
        final product = HiveProductModel(
          ...
          createdAt: widget.product.createdAt.toString(),
          ...
          updatedAt: widget.product.updatedAt.toString(),
          v: widget.product.v,
          englishName: widget.product.englishName,
        );
